...
var g = Symbol("vue-codemirror-global-config");
var y = function(e) {
  var t = e.config, n = function(e2, t2) {
    var n2 = {};
    for (var o2 in e2)
    ...
    if (e2 != null && typeof Object.getOwnPropertySymbols == "function") {
      var r = 0;
      for (o2 = Object.getOwnPropertySymbols(e2); r < o2.length; r++)
        t2.indexOf(o2[r]) < 0 && Object.prototype.propertyIsEnumerable.call(e2, o2[r]) && (n2[o2[r]] = e2[o2[r]]);
    }
    return n2;
  }(e, ["config"]), o = Array.isArray(t.extensions) ? t.extensions : [t.extensions];
  return EditorState.create({ doc: t.doc, selection: t.selection, extensions: o.concat([EditorView.updateListener.of(function(e2) {
    n.onUpdate(e2), e2.docChanged && n.onChange(e2.state.doc.toString(), e2), e2.focusChanged && (e2.view.hasFocus ? n.onFocus(e2) : n.onBlur(e2));
  })]) });
};
var O = function() {
  var e = new Compartment();
  return { compartment: e, run: function(t, n) {
    e.get(t.state) ? t.dispatch({ effects: e.reconfigure(n) }) : t.dispatch({ effects: StateEffect.appendConfig.of(e.of(n)) });
  } };
};
var h2 = function() {
  return O().run;
...
var w = function(e) {
  var t = O(), n = t.compartment, o = t.run;
  return function(t2, r) {
    var i = n.get(t2.state);
    o(t2, (r != null ? r : i !== e) ? e : []);
  };
};
var j = function(e) {
...
var C = function(e) {
  return [EditorState.tabSize.of(e), indentUnit.of(" ".repeat(e))];
};
var V = function(e) {
  return EditorView.theme({ "&": Object.assign({}, e) });
};
var z = { autofocus: { type: Boolean, default: void 0 }, disabled: { type: Boolean, default: void 0 }, indentWithTab: { type: Boolean, default: void 0 }, tabSize: Number, placeholder: String, style: Object, root: Object, extensions: Array, selection: Object };
var B = Object.freeze({ autofocus: false, disabled: false, indentWithTab: true, tabSize: 2, placeholder: "", extensions: [basicSetup] });
var A = defineComponent({ name: "VueCodemirror", props: Object.assign({ modelValue: { type: String, required: false, default: "" } }, z), emits: { "update:modelValue": function(e, t) {
  return true;
}, change: function(e, t) {
  return true;
}, update: function(e) {
  ...
  var s = ref(), l = { view: null, state: null }, d = Object.assign(Object.assign({}, B), inject(g, {})), m = computed(function() {
    return Object.keys(t).reduce(function(e, n) {
      var o, r;
      return Object.assign(Object.assign({}, e), ((o = {})[n] = (r = t[n]) !== null && r !== void 0 ? r : d[n], o));
    }, {});
  });
  return onMounted(function() {
    l.state = y({ config: { doc: t.modelValue, selection: m.value.selection, extensions: d.extensions }, onFocus: function(e2) {
      return c.emit("focus", e2);
    }, onBlur: function(e2) {
      return c.emit("blur", e2);
    }, onUpdate: function(e2) {
      return c.emit("update", e2);
    }, onChange: function(e2, n2) {
      e2 !== t.modelValue && (c.emit("update:modelValue", e2, n2), c.emit("change", e2, n2));
    } }), l.view = new EditorView({ state: l.state, parent: s.value, root: m.value.root });
    var e = h2();
    watch(function() {
      return t.extensions;
    }, function(t2) {
    ...
    var n = w(x());
    watch(function() {
      return m.value.disabled;
    }, function(e2) {
      return n(l.view, e2);
    }, { immediate: true });
    var o = w(S());
    watch(function() {
      return m.value.indentWithTab;
    }, function(e2) {
      return o(l.view, e2);
    }, { immediate: true });
    var r = h2();
    watch(function() {
      return m.value.tabSize;
    }, function(e2) {
      return r(l.view, C(e2));
    }, { immediate: true });
    var u = h2();
    watch(function() {
      return m.value.placeholder;
    }, function(e2) {
      return u(l.view, j(e2));
    }, { immediate: true });
    var a = h2();
    watch(function() {
      return m.value.style;
    }, function(e2) {
      return a(l.view, V(e2));
    }, { immediate: true }), watch(function() {
      return t.modelValue;
    }, function(e2) {
      e2 !== l.view.state.doc.toString() && function(e3, t2) {
        e3.dispatch({ changes: { from: 0, to: e3.state.doc.length, insert: t2 } });
      }(l.view, e2);
    }), m.value.autofocus && l.view.focus(), c.emit("ready", Object.assign(Object.assign({}, l), { container: s.value }));
  }), onBeforeUnmount(function() {
    l.view.destroy();
  }), function() {
    return h("div", { class: "v-codemirror", style: { display: "contents" }, ref: s });
  };
} });
var F = A;
var P = function(e, t) {
  e.component(A.name, A), function(e2, t2) {
    e2.provide(g, t2);
  }(e, t);
};
var T = { Codemirror: A, install: P };

// dep:vue-codemirror
var vue_codemirror_default = T;
export {
  F as Codemirror,
  B as DEFAULT_CONFIG,
