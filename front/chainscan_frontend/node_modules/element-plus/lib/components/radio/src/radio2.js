...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const inputAttrs = index.useAttrs({ excludeListeners: true });
    const labelListeners = index.useAttrs({
      excludeKeys: vue.computed(() => {
        return Object.keys(inputAttrs.value);
      })
    });
    const ns = index$1.useNamespace("radio");
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("label", vue.mergeProps({
        class: [
          ...
          vue.unref(rawAttrs).class
        ],
        style: vue.unref(containerStyle)
      }, vue.unref(labelListeners)), [
