...
// Ieip1155ABI is the input ABI used to generate the binding from.
// Deprecated: Use Ieip1155MetaData.ABI instead.
...
// Ieip1155Session is an auto generated Go binding around an Ethereum contract,
...
// Ieip1155CallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// Ieip1155TransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewIeip1155(address common.Address, backend bind.ContractBackend) (*Ieip1155, error) {
	contract, err := bindIeip1155(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &Ieip1155{Ieip1155Caller: Ieip1155Caller{contract: contract}, Ieip1155Transactor: Ieip1155Transactor{contract: contract}, Ieip1155Filterer: Ieip1155Filterer{contract: contract}}, nil
}
...
func NewIeip1155Caller(address common.Address, caller bind.ContractCaller) (*Ieip1155Caller, error) {
	contract, err := bindIeip1155(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &Ieip1155Caller{contract: contract}, nil
}
...
func NewIeip1155Transactor(address common.Address, transactor bind.ContractTransactor) (*Ieip1155Transactor, error) {
	contract, err := bindIeip1155(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &Ieip1155Transactor{contract: contract}, nil
}
...
func NewIeip1155Filterer(address common.Address, filterer bind.ContractFilterer) (*Ieip1155Filterer, error) {
	contract, err := bindIeip1155(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &Ieip1155Filterer{contract: contract}, nil
}

// bindIeip1155 binds a generic wrapper to an already deployed contract.
func bindIeip1155(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(Ieip1155ABI))
	if err != nil {
		return nil, err
	}
...
func (_Ieip1155 *Ieip1155Raw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Ieip1155.Contract.Ieip1155Caller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Ieip1155 *Ieip1155Raw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Ieip1155.Contract.Ieip1155Transactor.contract.Transfer(opts)
}
...
func (_Ieip1155 *Ieip1155Raw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Ieip1155.Contract.Ieip1155Transactor.contract.Transact(opts, method, params...)
}
...
func (_Ieip1155 *Ieip1155CallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Ieip1155.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Ieip1155 *Ieip1155TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Ieip1155.Contract.contract.Transfer(opts)
}
...
func (_Ieip1155 *Ieip1155TransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Ieip1155.Contract.contract.Transact(opts, method, params...)
}
...
func (_Ieip1155 *Ieip1155Caller) BalanceOf(opts *bind.CallOpts, account common.Address, id *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Ieip1155.contract.Call(opts, &out, "balanceOf", account, id)
...
func (_Ieip1155 *Ieip1155Session) BalanceOf(account common.Address, id *big.Int) (*big.Int, error) {
	return _Ieip1155.Contract.BalanceOf(&_Ieip1155.CallOpts, account, id)
}
...
func (_Ieip1155 *Ieip1155Caller) BalanceOfBatch(opts *bind.CallOpts, accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _Ieip1155.contract.Call(opts, &out, "balanceOfBatch", accounts, ids)
...
func (_Ieip1155 *Ieip1155Session) BalanceOfBatch(accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	return _Ieip1155.Contract.BalanceOfBatch(&_Ieip1155.CallOpts, accounts, ids)
}
...
func (_Ieip1155 *Ieip1155Caller) IsApprovedForAll(opts *bind.CallOpts, account common.Address, operator common.Address) (bool, error) {
	var out []interface{}
	err := _Ieip1155.contract.Call(opts, &out, "isApprovedForAll", account, operator)
...
func (_Ieip1155 *Ieip1155Session) IsApprovedForAll(account common.Address, operator common.Address) (bool, error) {
	return _Ieip1155.Contract.IsApprovedForAll(&_Ieip1155.CallOpts, account, operator)
}
...
func (_Ieip1155 *Ieip1155Caller) SupportsInterface(opts *bind.CallOpts, interfaceId [4]byte) (bool, error) {
	var out []interface{}
	err := _Ieip1155.contract.Call(opts, &out, "supportsInterface", interfaceId)
...
func (_Ieip1155 *Ieip1155Session) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _Ieip1155.Contract.SupportsInterface(&_Ieip1155.CallOpts, interfaceId)
}
...
func (_Ieip1155 *Ieip1155Transactor) SafeBatchTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _Ieip1155.contract.Transact(opts, "safeBatchTransferFrom", from, to, ids, amounts, data)
}
...
func (_Ieip1155 *Ieip1155Session) SafeBatchTransferFrom(from common.Address, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _Ieip1155.Contract.SafeBatchTransferFrom(&_Ieip1155.TransactOpts, from, to, ids, amounts, data)
}
...
func (_Ieip1155 *Ieip1155Transactor) SafeTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _Ieip1155.contract.Transact(opts, "safeTransferFrom", from, to, id, amount, data)
}
...
func (_Ieip1155 *Ieip1155Session) SafeTransferFrom(from common.Address, to common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _Ieip1155.Contract.SafeTransferFrom(&_Ieip1155.TransactOpts, from, to, id, amount, data)
}
...
func (_Ieip1155 *Ieip1155Transactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.Transaction, error) {
	return _Ieip1155.contract.Transact(opts, "setApprovalForAll", operator, approved)
}
...
func (_Ieip1155 *Ieip1155Session) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Ieip1155.Contract.SetApprovalForAll(&_Ieip1155.TransactOpts, operator, approved)
}
...
func (it *Ieip1155ApprovalForAllIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Ieip1155ApprovalForAll)
...
func (it *Ieip1155ApprovalForAllIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Ieip1155ApprovalForAllIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Ieip1155 *Ieip1155Filterer) FilterApprovalForAll(opts *bind.FilterOpts, account []common.Address, operator []common.Address) (*Ieip1155ApprovalForAllIterator, error) {
	...
	logs, sub, err := _Ieip1155.contract.FilterLogs(opts, "ApprovalForAll", accountRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return &Ieip1155ApprovalForAllIterator{contract: _Ieip1155.contract, event: "ApprovalForAll", logs: logs, sub: sub}, nil
}
...
func (_Ieip1155 *Ieip1155Filterer) WatchApprovalForAll(opts *bind.WatchOpts, sink chan<- *Ieip1155ApprovalForAll, account []common.Address, operator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Ieip1155.contract.WatchLogs(opts, "ApprovalForAll", accountRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(Ieip1155ApprovalForAll)
				if err := _Ieip1155.contract.UnpackLog(event, "ApprovalForAll", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Ieip1155TransferBatchIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Ieip1155TransferBatch)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Ieip1155TransferBatchIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Ieip1155TransferBatchIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Ieip1155 *Ieip1155Filterer) FilterTransferBatch(opts *bind.FilterOpts, operator []common.Address, from []common.Address, to []common.Address) (*Ieip1155TransferBatchIterator, error) {
	...
	logs, sub, err := _Ieip1155.contract.FilterLogs(opts, "TransferBatch", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &Ieip1155TransferBatchIterator{contract: _Ieip1155.contract, event: "TransferBatch", logs: logs, sub: sub}, nil
}
...
func (_Ieip1155 *Ieip1155Filterer) WatchTransferBatch(opts *bind.WatchOpts, sink chan<- *Ieip1155TransferBatch, operator []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Ieip1155.contract.WatchLogs(opts, "TransferBatch", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Ieip1155TransferBatch)
				if err := _Ieip1155.contract.UnpackLog(event, "TransferBatch", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Ieip1155TransferSingleIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Ieip1155TransferSingle)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Ieip1155TransferSingleIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Ieip1155TransferSingleIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Ieip1155 *Ieip1155Filterer) FilterTransferSingle(opts *bind.FilterOpts, operator []common.Address, from []common.Address, to []common.Address) (*Ieip1155TransferSingleIterator, error) {
	...
	logs, sub, err := _Ieip1155.contract.FilterLogs(opts, "TransferSingle", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &Ieip1155TransferSingleIterator{contract: _Ieip1155.contract, event: "TransferSingle", logs: logs, sub: sub}, nil
}
...
func (_Ieip1155 *Ieip1155Filterer) WatchTransferSingle(opts *bind.WatchOpts, sink chan<- *Ieip1155TransferSingle, operator []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Ieip1155.contract.WatchLogs(opts, "TransferSingle", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Ieip1155TransferSingle)
				if err := _Ieip1155.contract.UnpackLog(event, "TransferSingle", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Ieip1155 *Ieip1155Filterer) FilterURI(opts *bind.FilterOpts, id []*big.Int) (*Ieip1155URIIterator, error) {
	...
	logs, sub, err := _Ieip1155.contract.FilterLogs(opts, "URI", idRule)
	if err != nil {
		return nil, err
	}
	return &Ieip1155URIIterator{contract: _Ieip1155.contract, event: "URI", logs: logs, sub: sub}, nil
}
...
func (_Ieip1155 *Ieip1155Filterer) WatchURI(opts *bind.WatchOpts, sink chan<- *Ieip1155URI, id []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Ieip1155.contract.WatchLogs(opts, "URI", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Ieip1155URI)
				if err := _Ieip1155.contract.UnpackLog(event, "URI", log); err != nil {
					return err
				}
				event.Raw = log
